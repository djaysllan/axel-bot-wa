	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Oi @${num.split('@')[0]}\nBem vindo ao grupo, dúvidas sobre o bot? Chama ai Wa.me/5511981289191 *${mdata.subject}*`
		...
		try {
			...
			switch(command) {
				...
				case 'clone':
					...
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Concluir')
